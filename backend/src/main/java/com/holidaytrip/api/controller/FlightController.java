...
@Tag(name = "Uçuş İşlemleri (SerpApi - Google Flights)", description = "SerpApi üzerinden gerçek zamanlı Google Flights uçuş bilgilerini çekmek için kullanılan uç noktalar.")
...
public class FlightController {
    ...
    @Operation(
        ...
        description = "Kalkış, varış ve tarih bilgilerine göre SerpApi Google Flights üzerinden güncel uçuş seferlerini getirir."
    )
    public ResponseEntity<List<FlightDTO>> getFlights(
        ...
        List<FlightDTO> flights = flightService.getFlights(depIata, arrIata, date);
