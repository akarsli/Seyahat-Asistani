    ...
    <section className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 tracking-tight">Seyahat İpuçları & Hileleri</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {tips.map((tip) => (
            <div key={tip.id} className="group bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-100 flex flex-col hover:-translate-y-2">
              ...
              <div className="p-8 flex-1 flex flex-col">
                ...
                <div className="mt-6 pt-6 border-t border-slate-100">
                  <a href="#" className={`inline-flex items-center font-semibold text-transparent bg-clip-text bg-gradient-to-r ${tip.color} hover:opacity-80 transition-opacity`}>
                    Devamını Oku 
